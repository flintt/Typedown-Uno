...
public static class Loc
{
    private static readonly Dictionary<string, string> Zh = new()
    {
        ...
        ["AutoSave"] = "自动保存", ["RememberPosition"] = "记住光标和滚动位置", ["RestoreSession"] = "启动时恢复上次打开的文档", ["AlwaysShowTabBar"] = "始终显示标签栏",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["AutoSave"] = "Auto save", ["RememberPosition"] = "Remember caret and scroll position", ["RestoreSession"] = "Restore last session on start", ["AlwaysShowTabBar"] = "Always show the tab bar",
